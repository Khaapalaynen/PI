...
### Выведите строку 'win' 5 раз и выведите в верхнем регистре итог. В 1 строку результат должен быть.
...
### Результат
![Меню](https://github.com/Khaapalaynen/PI/blob/Te%D0%BC%D0%B0_2/pic/Lab2_10.png)

## Выводы
С помощью `upper()` вывели текст в верхнем регистре
